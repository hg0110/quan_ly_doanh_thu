...
import 'package:quan_ly_doanh_thu/pages/add_expense/blocs/get_expenses_bloc/get_expenses_bloc.dart';
  ...
  Widget build(BuildContext context) {
    return MultiBlocProvider(
        providers: [
          ...
          BlocProvider(
            create: (context) => DeleteDriverBloc(driverRepository: FirebaseDriverRepo()),
          ),
          //
              ...
              if (state.status == AuthenticationStatus.authenticated) {
                return MultiBlocProvider(
                  providers: [
                    ...
                    // BlocProvider(
                    //   create: (context) =>
                    //       GetExpensesBloc(FirebaseTransactionRepo())
                    //         ..add(GetExpenses()),
                    // ),
                    // BlocProvider(
                    //   create: (context) =>
