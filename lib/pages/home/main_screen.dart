                ...
                Column(
                  children: [
                    Container(
                        ...
                        child: BlocBuilder<GetTransactionBloc,
                            GetTransactionState>(builder: (context, state) {
                ...
                Expanded(
                  child: ListView.builder(
                      ...
                      itemBuilder: (context, int i) {
                        ...
                        final transactionOfDay = widget.transaction
                            .where((transaction) =>
                                transaction.date.isAfter(today) &&
                                transaction.date.isBefore(tomorrow))
                            .toList();
...
//   // await context.read<GetTransactionBloc>().add(GetTransaction());
// }
}
