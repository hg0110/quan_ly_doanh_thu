...
import 'package:quan_ly_doanh_thu/blocs/my_user_bloc/my_user_bloc.dart';
            ...
            return BlocBuilder<GetCustomerBloc, GetCustomerState>(
              ...
              if (state2 is GetCustomerSuccess) {
                return BlocBuilder<MyUserBloc, MyUserState>(
                  ...
                  // if (state3.status ==  MyUserStatus.success) {
                  return Scaffold(
                      appBar: AppBar(
                        backgroundColor:
                                ...
                                onPressed: () async {
                                  ...
                                  if (existingOrder != null) {
                                    ...
                                    setState(() {
                                      ...
                                      shippingOrder.user =
                                          state3.user ?? MyUser.empty;
                                    });
                                    context.read<CreateShippingOrderBloc>().add(
