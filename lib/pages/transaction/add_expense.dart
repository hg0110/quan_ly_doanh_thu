...
import 'package:quan_ly_doanh_thu/data/data.dart';
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        TextFormField(
                          ...
                          decoration: InputDecoration(
                            filled: true,
                            fillColor: transactions.category == Category.empty
                                ? Colors.white
                                : Color(transactions.category.color),
                            prefixIcon: transactions.category == Category.empty
                                ? const Icon(
                                ...
                                : Image.asset(
                                    'assets/${transactions.category.icon}.png',
                                    scale: 2,
                                  ),
